...
<div class="main">
  ...
  <?php
	...
	$sql = "select subjectsemesterforum, forumname from tblsubjectsemesterforum where subjectsemesterid = '$forumid'";
	...
	if($num > 0) {
		while($row = mysql_fetch_array($result, MYSQL_ASSOC)){
			//get row from result set
			  ...
			  echo"$forumname Forum";
		}
	}
  ?>
  </h3>
  <div class="maincontent">
  <p><a href="addpost.php?forumid=<?php echo $forumid ?>" target="actionframe">Add Post</a></p>
  <p>
    <iframe name="actionframe" width="100%" height="150" frameborder="0" id="actionframe"> </iframe>
  </p>
  
  </div>
  <div class="maincontent">
  <?php include("loadforumpost.php"); ?>
  </div></div>
